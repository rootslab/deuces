...
exports.Deuces = ( function () {
        ...
        , Deuces = function ( opt ) {
            ...
            var cfg = improve( clone( opt ), deuces_opt )
                ...
                , processCommandQueue = function ( address ) {
                    if ( logger.events.length ) me.emit( 'scanqueue', bilanx.cqueue.size() );
                ...
                , send = function ( ocmd ) {
                    ...
                    if ( ~ bilanx.push( ocmd ) ) {
                        ...
                        return me.ready ?
                               ...
                               logger.events.length ? me.emit( 'queued', ocmd, bilanx.cqueue.size() ) : null
                               ;
                    }
    ...
    dproto.initTasks = function ( events ) {
        var me = this
            ;
